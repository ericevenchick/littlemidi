...
//STALLIE, IDLEIE, TRNIE, and URSTIE are all enabled by default and are required
	...
	// IPC11 changed to IPC8
    #define USBEnableInterrupts() {IEC1bits.USBIE = 1;IPC8CLR=0x0000FF00;IPC8SET=0x00001000; INTEnableSystemMultiVectoredInt(); INTEnableInterrupts();}
#else
